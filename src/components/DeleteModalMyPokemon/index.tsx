...
const DeleteModal: React.FC<Props> = ({ inProp, onDelete, onCancel }) => {
  const buttonStyle = classnames('text-white text-sm tracking-wide font-bold px-4 py-2 rounded-lg bg-red-600')
